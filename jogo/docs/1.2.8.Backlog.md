...
| RF-07  | RF   | O jogador deve se movimentar com colisões no cenário e possuir esquiva (dash) com cooldown fixo reduzível por Destreza.                                                     |
| RF-08  | RF   | O jogador deve possuir stats primários (Força, Destreza, Inteligência), experiência, modificadores de atributos e seleção de tipo de personagem com atributos base distintos.|
...
| RF-10  | RF   | O jogo deve permitir uso de consumíveis utilitários fixos (bombas, chaves, poções), consumíveis de status (Força/Destreza/Inteligência) e consumíveis de benefício.          |
...
| RF-13  | RF   | O jogo deve definir tipos e quantidades de armas (classificadas por stat: Força/Destreza/Inteligência) e inimigos, incluindo um chefe (boss).                               |
...
| E-07   | Sistema de Atributos (Stats) | T-02 — Player      | Stats primários, modificadores e progressão          |
...
| US-25  | T-02 | E-07  | Como jogador, quero stats primários (Força, Destreza, Inteligência) no personagem, para que o desempenho mude conforme progressão e escolhas.                               | Must Have   |
...
| US-42  | T-05 | E-14  | Como jogador, quero tipos de arma definidos por stat primário (Pesada/Força, Ágil/Destreza, Intelectual/Inteligência), para que eu tenha estilos de combate diferentes.     | Must Have   |
...
| US-53  | T-02 | E-06  | Como jogador, quero realizar uma esquiva (dash) com cooldown fixo reduzível por Destreza, para que eu desvie de ataques inimigos durante o combate.                         | Must Have   |
| US-54  | T-02 | E-07  | Como jogador, ao subir de nível, quero que o jogo congele e me apresente a escolha entre +Força, +Destreza ou +Inteligência, para que eu personalize minha progressão.      | Must Have   |
...
| US-68  | T-04 | E-11  | Como jogador, quero usar consumíveis de status (Força, Destreza ou Inteligência) que concedem +1 no stat e +1 XP, para que eu fortaleça meu personagem durante a run.       | Must Have   |
...
| Revisão GDD × Tiny Rogues                   | Atualização de RFs/RNFs, épicos, USs existentes e adição de US-53 a US-72 | v1.0 | 01/06/2026 |