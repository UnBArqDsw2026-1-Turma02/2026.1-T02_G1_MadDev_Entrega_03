...
|---|---|---|---|
| 3.3.1 | Template Method (GoF) | [Ver página](/PadroesDeProjeto/3.3.1.TemplateMethod.md) | `EnemyBase.attack_sequence()` define a sequência fixa de ataque; `EnemyMelee` e `EnemyRanged` sobrescrevem etapas específicas. |
